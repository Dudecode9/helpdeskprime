...
_Generated: 2026-04-07T22:11:40.091Z_
...
Workspace `mcp.json` _(folder: ahelpdesk_prime)_

- **c:\Users\Dude\ahelpdesk_prime\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\Dude\AppData\Roaming\Code\User\mcp.json** — _File missing_
